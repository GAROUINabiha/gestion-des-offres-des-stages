...
$h = 'https://www.tanitjobs.com/jobs/?listing_type%5Bequal%5D=Job&searchId=1581866786.534&action=search&keywords%5Ball_words%5D=stage+informatique&GooglePlace%5Blocation%5D%5Bvalue%5D=&GooglePlace%5Blocation%5D%5Bradius%5D=50?searchId=1581866786.534&action=search&page=2';
$answer[$i]['lien'] = $h;
//title
...
function array_to_xml12( $answer, $xml_data ) {
...
array_to_xml12($answer,$xml_data);

//saving generated xml file; 
$xml_data->preserveWhiteSpace = false;
$result = $xml_data->asXML('stage12.xml');
...
$xml = simplexml_load_file("stage12.xml") or die("Error: Cannot create object");
